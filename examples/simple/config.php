...
*/
    ...
    App::addRoute('', 'controllers/index_controller.php', 'Index_Controller', 'indexAction');
    App::addRoute('.+', 'controllers/index_controller.php', 'Index_Controller', '#1Action');
    App::addRoute('.+', 'controllers/#1_controller.php', '#1^U_Controller', 'indexAction');
    App::addRoute('.+/.+', 'controllers/#1_controller.php', '#1^U_Controller', '#2Action');
