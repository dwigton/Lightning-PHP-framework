<div class ="page-content">
    ...
    <p>Three frameworks have gone into forming the way I think about code for the web
        I am indebted to CodeIgniter, Magento, and of course Rails. There are things
    ...
    <p>
        ...
        but still has some clunky bits that just make things ugly at times.
    </p>
    <p>
...
<div class="aside">
    <blockquote>
        <p>These quotes are a test to see how managing various views and script files works.</p>
    </blockquote>
    <blockquote>
        <p>I only ever quote myself because I can only remember the things I just said.</p>
    </blockquote>
    <blockquote>
        <p>A wise man once said "I like cheetos." He said a good many other things as well
        most of them are also not worth repeating.</p>
    </blockquote>
</div>
